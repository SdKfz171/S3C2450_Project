...
#define rTICNT1     (*(volatile unsigned char *)0x5700004C)	//Tick time count
#define rTICNT2     (*(volatile unsigned char *)0x57000048)	//Tick time count
...
// SPI       
#define CH_CFG0					(*(volatile unsigned *)0x52000000)
#define CLK_CFG0				(*(volatile unsigned *)0x52000004)
#define MODE_CFG0			(*(volatile unsigned *)0x5200000C)
#define SPI_STATUS0				(*(volatile unsigned *)0x52000014)
#define SPI_TX_DATA0		(*(volatile unsigned *)0x52000018)
#define SPI_RX_DATA0		(*(volatile unsigned *)0x5200001C)

#define CH_CFG1					(*(volatile unsigned *)0x59000000)
#define CLK_CFG1				(*(volatile unsigned *)0x59000004)
#define MODE_CFG1			(*(volatile unsigned *)0x5900000C)
#define SPI_STATUS1				(*(volatile unsigned *)0x59000014)
#define SPI_TX_DATA1		(*(volatile unsigned *)0x59000018)
#define SPI_RX_DATA1		(*(volatile unsigned *)0x5900001C)
